	...
	$.when(
		...
		.done(function(git, blogger){
			...
			posts.forEach(function(post){
				$posts.append('<div class="col-md-4"><a href="' + post.link + '" target="_blank"><h3>' + post.title + '</h3><p>' + post && post.description < postLength ? post.description : post.description.substr(0,postLength) + '</p></a></div>')
			});
